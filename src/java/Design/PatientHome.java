...
public class PatientHome extends HttpServlet {
    ...
    //out.println("</script>");
            ...
            out.println("</table>");
                     out.println("</div>");
             out.println("<div class=slider><img src=image/med.jpg style='height:180;width:890px;'></div>");
        ...
        out.println("<div style=width: 200px; float: left;background-color:#F4E7BD;color:white;'>");
                ...
                out.println("<ul>");
                out.println("<br><li><a  style='color:white;text-decoration:none;' href=Location?user="+user+"><span>Select Location</span></a></li><br><br>");
                
             //out.println("<li><a  style='color:white;text-decoration:none;'href=AddDoctor target=_blank><span>Add Doctor</span></a></li><br><br>");
              //out.println("<li><a href=viewDoctor target=_blank><span>View Student Report Card</span></a></li><br>");
              out.println("<li><a style='color:white;text-decoration:none;' href=Location?user="+user+"><span>Choose Specialist</span></a></li><br><br>");
             //out.println("<li><a style='color:white;text-decoration:none;' href=UpdateDocInfo title=From Client><span>Update Doctor Information</span></a></li><br><br>");
           
              out.println("<li><a style='color:white;text-decoration:none;' href=PChngpass?user="+user+"><span>Change Password</span></a></li><br>");
          out.println("</ul>");
           //out.println("<li><a style='color:white;text-decoration:none;' href=ShowAllDoct><span>Show All Doctors</span></a></li><br><br>");
           out.println("<img src=image/large1.jpg style='height:210px;width:250px;'><br>");
