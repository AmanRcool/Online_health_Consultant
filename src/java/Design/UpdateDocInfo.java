 ...
 * @author Dell
 */
public class UpdateDocInfo extends HttpServlet {
    ...
    //out.println("</script>");
            ...
            out.println("<form action=UpdateDocInfoCnf method=post>");
           ...
           out.println("<tr style='height:50px;color:#003366;'>");
            ...
            out.println("<td style='width: 100px;text-align:center;'>&nbsp;<input type=submit value=UPDATE style='width:100px;' /></td>");
