 ...
 * @author Dell
 */
public class ShowAllDoct extends HttpServlet {
...
out.println("<html>");
    ...
    //out.println("</script>");
            ...
            out.println("</style>");
            out.println("<style type='text/css'>.main{background-color:lightsteelblue;height:900px;width:900px;}");    
            out.println("</style>");
            ...
            out.println("</table>");
             ...
             out.println("<div class=slider><img src=image/internet.jpg style='height:180;width:900px;'></div>");
              ...
              out.println("<center><br><b style='color:#003366;font-size:18px;'>ALL DOCTOR'S AVAILABLE  HERE...</b><hr/></center>");
              
              String user=request.getParameter("user");
DBConnection db=new DBConnection();
db.stmt=db.con.createStatement();
db.rst=db.stmt.executeQuery("select dname,pass,email,specialization,ms,address,fee from adddoc");
out.println("<br><table border=1 cellspacing=0><tr><th style='color:#003366;'>Docter name</th><th style='color:#003366;'>Password</th><th style='color:#003366;'>Email_Id</th><th style='color:#003366;'>Specialization</th><th style='color:#003366;'>MS/MD</th><th style='color:#003366;'>Address</th><th style='color:#003366;'>Fees</th></tr>");
while(db.rst.next())
{
...
out.println("<td>"+db.rst.getString(7)+"</td></tr>");
