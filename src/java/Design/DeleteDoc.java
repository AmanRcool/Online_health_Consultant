    ...
    //out.println("</script>");
            ...
            out.println("</table>");
             ...
             out.println("<div class=slider><img src=image/internet.jpg style='height:180;width:900px;'></div>");
              ...
              out.println("<center><br><b style='color:#003366;font-size:18px;'>DELETE  DOCTORS   HERE...</b><hr/></center>");
              
            out.println("<table style='width:600px;height:200px; cellspacing=0 cellpadding=0 border=0 '>");
            out.println("<form action=DeletedocCnf method=post>");
            ...
            out.println("<td style='width: 250px;text-align:left;'>&nbsp;<input type=text name=em style='width:180px;' />");
            out.println("</td>");
           ...
           out.println("<tr style='height:50px;color:#003366;'>");
            ...
            out.println("<td style='width: 100px;text-align:center;'>&nbsp;<input type=submit value=DELETE style='width:100px;' /></td>");
