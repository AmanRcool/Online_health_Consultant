...
public class Dlist extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<form action=Cspea method=post>");
        ...
        //  out.println("user"+user);
            ...
            db.rst=db.stmt.executeQuery("SELECT DISTINCT email FROM adddoc where address='"+addr+"' and specialization='"+sp+"' ");
            out.println("<tr style='height:50px;color:#003366;'>");
            out.println("<td style='width:50px;'>&nbsp;</td>");
            out.println("<td style='width: 250px;text-align:left;'>&nbsp;Doctor's List</td>");
            out.println("<td style='width: 100px;text-align:center;'>&nbsp;:</td>");
            out.println("<td style='width: 250px;text-align:left;'>&nbsp;<select name=dl style=width:200px;'>");
            out.println("<option>DOCTOR'S LIST</option>");
