    ...
    //out.println("</script>");
            ...
            out.println("</table>");
             ...
             out.println("<div class=slider><img src=image/internet.jpg style='height:180;width:900px;'></div>");
              ...
              out.println("<form action=LoginConf method=post>");
	out.println("<table style='width:250px;height:400px;border:1px solid #003366;;'>");
        ...
        out.println("<div style=width: 200px; float: left;background-color:#F4E7BD;color:white;'>");
             ...
             out.println("<li><a  style='color:white;text-decoration:none;'href=AddDoctor target=_blank><span>Add Doctor</span></a></li><br><br>");
              ...
              out.println("<li><a style='color:white;text-decoration:none;' href=DeleteDoc><span>Delete Doctor</span></a></li><br><br>");
             out.println("<li><a style='color:white;text-decoration:none;' href=UpdateDocInfo title=From Client><span>Update Doctor Information</span></a></li><br><br>");
              ...
              out.println("<li><a style='color:white;text-decoration:none;' href=Chngpass><span>Change Password</span></a></li><br><br>");
          
           out.println("<li><a style='color:white;text-decoration:none;' href=ShowAllDoct><span>Show All Doctors</span></a></li><br><br>");
            out.println("<li><a style='color:white;text-decoration:none;' href=ShowAllPatient><span>Show All Patient</span></a></li><br><br>");
             out.println("</ul>");
                     out.println("</table>");
	    ...
	    out.println("</form>");
            ...
            out.println("</div>");
            out.println("<div style='width:648px;height:400px;float:left;background-color: #F4E7BD;'>");
