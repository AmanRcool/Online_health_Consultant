...
public class PatientList extends HttpServlet {
   ...
   DBConnection db=new DBConnection();
    ...
    db.rst=db.stmt.executeQuery("select dname,demail,specialization,pname,pemail,paddress,date from patientlist where demail='"+user+"'");
    out.println("<br><table border=1 cellspacing=0><tr><th style='color:#003366;'> Doctor's Name</th><th style='color:#003366;'>Doctor's Email</th><th style='color:#003366;'>Specialization</th><th style='color:#003366;'>Patient Name</th><th style='color:#003366;'>Patient's Email</th><th style='color:#003366;'>Patient Address</th><th style='color:#003366;'>Date</th></tr>");
    while(db.rst.next())
{
