    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
         ...
         try 
        {
         ...
         // out.println("user"+user);  
            ...
            out.println("<style type='text/css'>.box{height:1540px;width:900px;}") ;
            out.println("</style>");
            ...
            out.println("</style>");
            out.println("<style type='text/css'>.main{background-color:lightsteelblue;height:1000px;width:900px;}");    
            out.println("</style>");
            ...
            out.println("<div class=main>");
             ...
             out.println("<center><br><b style='color:#003366;font-size:18px;'>This Is The Final Report...</b><hr/></center>");
              out.println("<center><table style='width:600px;height:950px; cellspacing=0 cellpadding=0 border=0 '>");
            
             out.println("<form action=PatientHome method=post>");
          ...
          //out.println("user"+user);  
           ...
           DBConnection db=new DBConnection();
             ...
             db.rst=db.stmt.executeQuery("select dname,specialization,fee from adddoc where email='"+dl+"'");
             if(db.rst.next())
            {
